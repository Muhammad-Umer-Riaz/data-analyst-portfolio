...
- **Machine Learning** — classification pipelines, cross-validation, hyperparameter tuning, GridSearchCV, ROC-AUC, precision-recall analysis
- **Data Cleaning** — datetime engineering, regex parsing, star schema design, feature engineering
- **Visualisation & BI** — matplotlib, seaborn, Power BI (DAX measures, data modelling, power query, dashboards)
- **Analytics** — supplier performance scoring, stockout reconstruction, statistical testing (Pearson, Spearman, Chi-squared), composite scoring, churn prediction
- **Other** — Git/GitHub, ERP data structures (SAP-style schemas)

---

## 📬 Connect

- GitHub: [Muhammad-Umer-Riaz](https://github.com/Muhammad-Umer-Riaz)
- LinkedIn: [Muhammad Umer Riaz](https://www.linkedin.com/in/muhammad-umer-riaz)
- Email: muhammad.umer2149@gmail.com
