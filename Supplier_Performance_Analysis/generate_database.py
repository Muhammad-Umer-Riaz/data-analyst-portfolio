...
def populate_tables(conn):
    ...
    for _ in range(2000):
        ...
        purchase_document_number = random.randint(1, 1000)  # Assuming num_purchase_orders = 1000
        ...
        material_number = random.randint(1, 500)  # Assuming num_materials = 500
        plant = 'Plant' + str(random.randint(1, 5))
